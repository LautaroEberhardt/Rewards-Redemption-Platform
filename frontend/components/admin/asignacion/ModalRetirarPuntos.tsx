...
export const ModalRetirarPuntos = ({
  usuario,
  estaAbierto,
  alCerrar,
  alCompletar,
  ...
  const manejarEnvio = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alCompletar();
      alCerrar();
      alert(`¡Se retiraron puntos de ${usuario.nombre}!`);
    } catch (error) {
